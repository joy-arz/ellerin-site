export function FloatingElements() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div 
        className="absolute w-96 h-96 rounded-full border border-primary/10 animate-float"
        style={{ top: '10%', right: '10%' }}
      />
      
      {/* Medium floating square */}
      <div 
        className="absolute w-32 h-32 border border-primary/5 rotate-45 animate-float-reverse"
        style={{ top: '60%', left: '5%' }}
      />
      ...
      <div 
        className="absolute w-20 h-20 border-2 border-primary/8 rounded-full animate-float"
        style={{ 
          top: '15%', 
          left: '70%',
          animationDelay: '4s',
      ...
      <div 
        className="absolute w-6 h-6 border border-primary/12 rotate-12 animate-float-reverse"
        style={{ 
          top: '85%', 
          left: '40%',
          animationDelay: '2.5s',
